...
\begin{minted}[escapeinside=!!, startinline, samepage, firstnumber=22, breaklines]{php}
$uid = $row['id'];
...
\begin{minted}[samepage, firstline=2, lastline=12, firstnumber=26, breaklines]{html+php}
<?php
if($row['isRestricted']){
    ?>
